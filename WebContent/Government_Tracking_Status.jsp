...
<body>	
	       ...
	       <tr>
			<th ><label for="txt_Pid" style="color:White;font-size:18px;">T Id</label></th> 
	...
	ResultSet rs=st.executeQuery("select * from tbl_tracker_info");
	while(rs.next())
	{
		id=Integer.parseInt(rs.getString(1));
		name=rs.getString("Accecpt_status");
...
%>
			...
			<td> <a href="Government_Tracking_Page.jsp?txt_tid=<%=id %>&roll=<%=name %>">
			<input type="button" class="btn btn-success" value="View"></a>
			</td>
			 </tr>
<%
	}

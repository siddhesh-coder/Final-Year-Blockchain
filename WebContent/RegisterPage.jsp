							...
							<table class="table table-responsive table-bordered">
								<tr>
									<td class="col-md-2"><label for="txt_Uname"
										style="color: White; font-size: 18px;">Select Roll:</label></td>
									<td class="col-md-6"><select name="roll"
										class="form-control">
								...
								<tr>
									<td class="lable"><label for="txt_Uname"
										style="color: White; font-size: 18px;">Gender:</label></td>

									<td align=left><input type="radio" name="rdoGender"
										value="Male" id="male" required /><label for="txt_Uname"
										style="color: White; font-size: 18px;">Male</label> <input
										type="radio" name="rdoGender" value="FeMale" id="female"
										required /><label for="txt_Uname"
										style="color: White; font-size: 18px;">Female</label></td>
								</tr>
								<tr>
									<td class="lable"><label for="txt_Uname"
								...
								<tr>
									<td class="lable"><label for="txt_Uname"
										style="color: White; font-size: 18px;">Contact No:</label></td>
									<td><input type="text" required
								...
								<tr>
									<td class="lable"><label for="txt_Uname"
										style="color: White; font-size: 18px;">Aadhaar Card:</label></td>
									<td><input type="text" required name="Aadhaarid" "pattern="[2-9]{1}[0-9]{12}" maxlength="12"
										class="form-control" /></td>
								</tr>
								<tr>

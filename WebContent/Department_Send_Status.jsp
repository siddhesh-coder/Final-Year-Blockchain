...
<body>	
			...
			<form action="dept_request" method="post">
			<div align="center">
	...
	ResultSet rs=st.executeQuery("select * from tbl_tracker_info where R_ID='"+ids+"' and Accecpt_status='District'");
	if(rs.next())
	{
		id=Integer.parseInt(rs.getString(1));
		Funds_Name=rs.getString(3);
		Funds_amount=rs.getString(5);
		
		 
%>
<tr>
			<td class="col-md-2"><label for="txt_Pname" style="color:White;font-size:18px;">ID:</label></td>
			<td class="col-md-6"><input type="text" class="form-control" name="id" required id="txt_id" value="<%=ids %>" readonly="readonly"></td>
			</tr>
		    <tr>

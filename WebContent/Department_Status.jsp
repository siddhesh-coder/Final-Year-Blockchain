...
<body>	
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				         <jsp:include page="Depmenu.jsp"></jsp:include>
				        </ul>
	...
	ResultSet rs=st.executeQuery("select * from user_request_funds where Government_status='Accept' and District_status='Accept' and Department_status='Sending' and State_Gov_status='Accept'");
	while(rs.next())
	{
		...
		ResultSet rs1=st1.executeQuery("select * from tbl_tracker_info where Accecpt_status='District'");
		while(rs1.next())
		{	
...
%>
			...
			<td> <a href="Department_Send_Status.jsp?txt_id=<%=id %>">

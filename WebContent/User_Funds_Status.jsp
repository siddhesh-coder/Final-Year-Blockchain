...
<body>	
					...
					<div >
						<div >
							<div class="title text-center">
								<h1 class="mb-10 text-white">Show Status</h1>
								<br>
							</div>
	       ...
	       <tr>
		    ...
		    <th ><label for="txt_Pid" style="color:White;font-size:18px;">Funds Amount</label></th>
		      <th ><label for="txt_Pid" style="color:White;font-size:18px;">Transfer Amount</label></th>
		      </tr>
	...
	ResultSet rs=st.executeQuery("select * from tbl_tracker_info where Accecpt_status='Department'");
	while(rs.next())
	{
		name=rs.getString(3);
		amount=rs.getString(4);
		Transfer_amount=rs.getString(5);
...
%>
			...
			<td><label for="txt_Pid" style="color:Black;font-size:18px;"><%=Transfer_amount %></label></td>

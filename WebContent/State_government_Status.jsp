...
<body>	
	...
	ResultSet rs=st.executeQuery("select * from user_request_funds where Government_status='Accept' and State_Gov_status='Sending'");
	while(rs.next())
	{
...
%>
			...
			<td> <a href="Send_State_government_Status.jsp?txt_id=<%=id %>">

...
/**
 * Servlet implementation class dept_request
 */
@WebServlet("/dept_request")
public class dept_request extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String emailid=Dbconn.Departmentemail;
		System.out.println("Departmentemail=>"+emailid);
		...
		try {
			...
			st.executeUpdate("update user_request_funds set Department_status='"+status+"' where Department_Email='"+emailid+"' and U_ID='"
					+ id + "'");
			System.out.println("OK ");
			String data="Department"+"#"+txt_Pname+"#"+txt_db_amount+"#"+txt_Pprice+"#"+accecpt_status+"#"+emailid;
